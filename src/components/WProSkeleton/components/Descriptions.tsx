...
const DescriptionsLargeItemSkeleton = ({ active }: {
  ...
  <div style={{ marginTop: '32px' }}>
    <w-skeleton active={active} size="small" propsStyle={{ width: '100px', marginBottom: '16px' }} />
    <div
      style={{
        width: '100%',
...
export const TableSkeleton = ({ active, size = 4 }: {
  ...
  <a-card bordered={false}>
    <w-skeleton active={active} propsStyle={{ width: '100px', marginBottom: '16px' }} size="small" />
