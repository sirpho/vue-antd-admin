<template>
  ...
  <a-typography>
    <a-typography style="color: #454d64;">
      通过
      <span style="padding: 2px 5px;color: #d56161;background: #f6f7f9;">
        image
      </span>
...
export default defineComponent({
  setup() {
    const imageUrl = ref('https://gw.alipayobjects.com/zos/bmw-prod/59a18171-ae17-4fc5-93a0-2645f64a3aca.svg')
    return {
      imageUrl
    }
  }
